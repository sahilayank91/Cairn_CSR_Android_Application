...
public  class AttendanceFragment extends Fragment {
    ...
    public void setData(String scope,ArrayList<Long>head_count,ArrayList<Long>dates){
        this.scope=scope;
        this.smiles=head_count;
        this.dates=dates;
    ...
    public void generateData() {
        if(scope.equals("week")) {
            ...
            for (int i = 0; i < numColumns; ++i) {
                ...
                values.add(new SubcolumnValue(smiles.get(i), getColorSelect(i)));
                Column column = new Column(values);
                column.setHasLabels(smiles.get(i)!=0);
